...
const InsightCard = ({ imgUrl, title, subtitle, index }) => (
  <motion.div variants={fadeIn('up', 'spring', index * 0.5, 1)} className="flex md:flex-row flex-col gap-4">
    ...
    <div className="w-full flex justify-between items-center">
      <div className="flex-1 md:ml-[62px] flex flex-col m-w-[650px]">
      ...
      <div className="lg:flex hidden items-center justify-center rounded-full bg-transparent w-[100px] h-[100px] border-[1px] boredr-white">
