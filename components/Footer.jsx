    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      <div className="flex item-center justify-between flex-wrap gap-5">
        ...
        <button type="button" className="flex items-center h-fit py-4 px-6 bg-[#25618B] rounded-[32px] gap-[12px]">
          <img src="/headset.svg" alt="headset" className="w-[24px] h-[24px] object-cotain" />
      ...
      <div className="flex flex-col">
        ...
        <div className="flex item-center justify-between flex-wrap gap-4">
          ...
          <p className="font-normal text-[14px] text-white opacity-50">copyright &copy; 2023 Metaversus. All right reserved.</p>
